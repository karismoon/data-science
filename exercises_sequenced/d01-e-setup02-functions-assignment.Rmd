...
arguments: vector of quantities, vector of probabilities, number of observations, vector of means, vector of standard deviations, logical where true means probabilities p are given as log(p) and a logical where true means probabilities are p(X greater than or equal to x)
