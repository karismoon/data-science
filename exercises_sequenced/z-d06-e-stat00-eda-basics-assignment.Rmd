...
**Observations**:
- no, there are the most ideal cuts D:
...
**Observations**:
- I don't know, they all have the same ranges lollllllll
...
**Observations**:
- The prices of all of them are similar
...
**Observations**:
- I don't think it supports the hypothesis, the box plots look very similar for each type of cut.
